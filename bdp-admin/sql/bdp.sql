...
CREATE DATABASE IF NOT EXISTS bdp DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `bdp`.`conf_connect_type` (
  ...
  `mod_time` DATETIME NULL COMMENT '修改时间',
  `mod_per` INT NULL COMMENT '修改用户',
  PRIMARY KEY (`id`))
...
-- -----------------------------------------------------
-- Table `bdp`.`conf_connect`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bdp`.`conf_connect` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` VARCHAR(100) NULL COMMENT '连接名称',
  `type_id` INT NULL COMMENT '连接类型',
  `host` VARCHAR(100) NULL COMMENT '主机名',
  `port` VARCHAR(100) NULL COMMENT '端口',
  `username` VARCHAR(100) NULL COMMENT '用户名称',
  `password` VARCHAR(100) NULL COMMENT '密码',
  `dbname` VARCHAR(100) NULL COMMENT '数据库名称',
...
-- Table `bdp`.`job_set`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bdp`.`job_set` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` VARCHAR(100) NULL COMMENT '任务集名称',
  `desc` VARCHAR(100) NULL COMMENT '任务集描述',
  `create_time` DATETIME NULL COMMENT '创建时间',
  `create_per` INT NULL COMMENT '创建用户',
  `mod_time` DATETIME NULL COMMENT '修改时间',
  `mod_per` INT NULL COMMENT '修改用户',
...
-- Table `bdp`.`job_info`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bdp`.`job_info` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '任务编号',
  `name` VARCHAR(100) NULL COMMENT '任务名称',
  `type_id` INT NULL COMMENT '任务类型 1 数据接入 2 SQL计算 3 程序执行 4 数据推送',
  `desc` VARCHAR(100) NULL COMMENT '任务描述',
  `enable` TINYINT(1) NULL COMMENT '任务状态',
  `create_time` DATETIME NULL COMMENT '创建时间',
  `create_per` INT NULL COMMENT '创建用户',
  `mod_time` DATETIME NULL COMMENT '修改时间',
  `mod_per` INT NULL COMMENT '修改用户',
...
-- -----------------------------------------------------
-- Table `bdp`.`job_run_history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bdp`.`job_run_history` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '编号',
  `num` BIGINT(20) NULL COMMENT '运行编号',
  `params` VARCHAR(100) NULL COMMENT '运行参数',
  `state` TINYINT(1) NULL COMMENT '运行状态',
  `cost` BIGINT(20) NULL COMMENT '运行耗时 单位ms',
  `time` DATETIME NULL COMMENT '开始运行的时间',
  `log` longtext NULL COMMENT '运行的日志信息',
...
-- -----------------------------------------------------
-- Table `bdp`.`job_info_conf`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bdp`.`job_info_conf` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '编号',
...
-- Table `bdp`.`job_stat`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bdp`.`job_stat` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '编号',
  `stat_date` DATE NULL COMMENT '统计时间',
